...
CREATE TABLE enterprise_auth (
  ...
  legal_person_id_no VARCHAR(100) COMMENT '法人身份证号(加密)',
  legal_person_phone VARCHAR(100) COMMENT '法人手机号(加密)',
...
CREATE TABLE buyer_engagement (
  id BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  buyer_enterprise_id BIGINT NOT NULL COMMENT 'FK enterprise.id 买方企业',
