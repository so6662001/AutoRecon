...
CREATE UNIQUE INDEX IF NOT EXISTS uk_event_id ON analytics_event(event_id);
CREATE INDEX IF NOT EXISTS idx_ae_event_time ON analytics_event(event_time);
CREATE INDEX IF NOT EXISTS idx_ae_system ON analytics_event(system);
CREATE INDEX IF NOT EXISTS idx_ae_enterprise ON analytics_event(enterprise_id);
CREATE INDEX IF NOT EXISTS idx_ae_page_path ON analytics_event(page_path);
CREATE INDEX IF NOT EXISTS idx_ae_event_type_name ON analytics_event(event_type, event_name);

-- 39. analytics_page_daily
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_apd_date_system_path ON analytics_page_daily(stat_date, system, page_path);

-- 40. analytics_action_daily
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_aad_date_system_event ON analytics_action_daily(stat_date, system, event_name, action_category);

-- 41. analytics_report_config
